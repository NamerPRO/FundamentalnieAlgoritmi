...
//        }
    ...
    template<
            ...
            >
class binary_search_tree : private ntools::nmalloc, public ncontainer::associative_container<tkey, tvalue, tkey_comporator> {
    ...
    protected:
        ...
        virtual unsigned int get_node_size() {
...
//                find_template finder;
                find_inner(key, _root_node, nodes_stack);
...
//                    tkey const & key,
    ...
    private:
        ...
        tvalue remove_inner(
            ...
            if (find_inner(key, _root_node, nodes_stack) == nullptr) {
...
//            nodes_stack.pop();
            ...
            after_element_removed(key, _root_node, nodes_stack);
...
//                    return node_to_return;
    ...
    protected:
        ...
        void rotate_left(
                ...
                tree_node * rotate_root_parent
                ) {
            before_left_rotate(rotate_root, rotate_root_parent);
            ...
            if (rotate_root_parent->left_child == rotate_root) {
                rotate_root_parent->left_child = saved_right_child;
            } else {
                rotate_root_parent->right_child = saved_right_child;
            }

            after_left_rotate(rotate_root, rotate_root_parent);
        }

        virtual void before_left_rotate(
                tree_node * rotate_node,
                tree_node * rotate_node_parent
                ) {
        ...
        void rotate_right(
            ...
            before_right_rotate(rotate_root, rotate_root_parent);
            ...
            if (rotate_root_parent->left_child == rotate_root) {
                rotate_root_parent->left_child = saved_left_child;
            } else {
                rotate_root_parent->right_child = saved_left_child;
            }

            after_right_rotate(rotate_root, rotate_root_parent);
        }

        virtual void before_rigth_rotate(
                tree_node * rotate_node,
                tree_node * rotate_node_parent
        ) {
