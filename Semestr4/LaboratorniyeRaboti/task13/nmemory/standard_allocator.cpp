...
nstandards::standard_allocator::standard_allocator(nlogger::logger * mem_logger) {
...
void* nstandards::standard_allocator::allocate(size_t target_size) const {
...
void nstandards::standard_allocator::deallocate(void const * target_to_deallocate) const {
