...
//        intptr_t get_pointer_distance(void * ptr_1, void * ptr_2) const;
    ...
    public:
        ...
        sorted_list_memory(nmemory::memory * allocator, size_t memory_size, nmemory_standards::allocate_type_helper::allocate_type type, nlogger::logger * memory_logger);
...
//        sorted_list_memory(void const * memory, size_t memory_size, allocate_type type);
        ...
        ~sorted_list_memory() noexcept override;
    };
