                ...
                case '!': {
                    ...
                    while (char_token == '@') {
                        ...
                        npipeline::pipeline_base::pipeline_passage data = {
                            std::get<unsigned long>(data_as_vector[0]),
                            std::get<unsigned long>(data_as_vector[1]),
                            {
                                std::get<unsigned long>(data_as_vector[2]),
                                factory.get_string(std::move(std::get<std::string>(data_as_vector[3]))),
                                factory.get_string(std::move(std::get<std::string>(data_as_vector[4])))
                            },
                            factory.get_string(std::move(std::get<std::string>(data_as_vector[5]))),
                            factory.get_string(std::move(std::get<std::string>(data_as_vector[6]))),
                            factory.get_string(std::move(std::get<std::string>(data_as_vector[7]))),
                            factory.get_string(std::move(std::get<std::string>(data_as_vector[8]))),
                            factory.get_string(std::move(std::get<std::string>(data_as_vector[9]))),
                            factory.get_string(std::move(std::get<std::string>(data_as_vector[10])))
                        };
