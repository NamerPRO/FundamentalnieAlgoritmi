...
namespace nmemory_standards {
    ...
    class boundary_descriptors_memory : public nmemory::memory {
...
//        static uint32_t get_balanced_block_size(uint32_t target_size, uint32_t empty_block_size);
    ...
    public:
        ...
        boundary_descriptors_memory(void const * memory, size_t memory_size, nmemory::memory::allocate_type type, nlogger::logger * memory_logger);
