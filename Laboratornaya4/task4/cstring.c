...
int scompare(string* lhs, char* rhs) {
  return string_compare("%p", standart_string_comporator, lhs, rhs);
}

int scompare_s(string* lhs, string* rhs) {
  return string_compare("%s", standart_string_comporator, lhs, rhs);
}
